...
if __name__ == '__main__':
    ...
    log_loss = []
    for i in range(8760):
        beta_mismatch_cdf = lambda d: beta.cdf((d - (-115)) /(93.75+115), df["concentration1"][i], df["concentration0"][i])
        beta_mismatch_pdf = lambda d: (1/(93.75+115)) * (beta.pdf((d - (-115)) /(93.75+115), df["concentration1"][i], df["concentration0"][i]))
