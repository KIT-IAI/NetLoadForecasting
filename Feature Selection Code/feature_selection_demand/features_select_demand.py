...
if __name__ == '__main__':
    ...
    # DATAPATH to set
    data = pd.read_pickle("demand_0.pkl")
    ...
    for k in range(2,len(category_full) +1 ):
        ...
        score = cross_val_score(model, X[tmp_set], y, scoring='neg_root_mean_squared_error', cv=cv, n_jobs=-1, error_score='raise',
                        verbose=1)
